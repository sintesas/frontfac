...
export class ListaDinamicaService {
  ...
  // Nombres Listas
  private apiGetNombresListasFull = this.api.getBaseUrl + "auth/listadinamica/getNombresListasFull";
  private apiGetNombresListas = this.api.getBaseUrl + "auth/listadinamica/getNombresListas";
  private apiCreateNombresListas = this.api.getBaseUrl + "auth/listadinamica/crearNombresListas";
  private apiUpdateNombresLitas = this.api.getBaseUrl + "auth/listadinamica/actualizarNombresListas";

  // Listas Dinamicas
  private apiGetListasDinamicasFull = this.api.getBaseUrl + "auth/listadinamica/getListasDinamicasFull";
  private apiGetListasDinamicas = this.api.getBaseUrl + "auth/listadinamica/getListasDinamicas";
  private apiCreateListasDinamicas = this.api.getBaseUrl + "auth/listadinamica/crearListasDinamicas";
  private apiUpdateListasDinamicas = this.api.getBaseUrl + "auth/listadinamica/actualizarListasDinamicas";
