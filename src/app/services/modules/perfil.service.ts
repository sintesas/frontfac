...
export class PerfilService {
  ...
  private apiGetPerfiles = this.api.getBaseUrl + "auth/perfil/getPerfiles";
  private apiGetPerfilesFull = this.api.getBaseUrl + "auth/perfil/getPerfilesFull";
  private apiCreatePerfiles = this.api.getBaseUrl + "auth/perfil/crearPerfiles";
  private apiUpdatePerfiles = this.api.getBaseUrl + "auth/perfil/actualizarPerfiles";
