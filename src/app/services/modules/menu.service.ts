...
export class MenuService {
  ...
  private apiGetMenu = this.api.getBaseUrl + "auth/menu/getMenus";
  private apiCreateMenu = this.api.getBaseUrl + "auth/menu/crearMenus";
  private apiUpdateMenu = this.api.getBaseUrl + "auth/menu/actualizarMenus";
