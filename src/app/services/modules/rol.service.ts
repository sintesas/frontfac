...
export class RolService {
  ...
  private apiGetRoles = this.api.getBaseUrl + "auth/rol/getRoles";
  private apiGetRolesActivos = this.api.getBaseUrl + "auth/rol/getRolesActivos";
  private apiCreateRoles = this.api.getBaseUrl + "auth/rol/crearRoles";
  private apiUpdateRoles = this.api.getBaseUrl + "auth/rol/actualizarRoles";
  private apiGetRolPrivilegiosById = this.api.getBaseUrl + "auth/rol/getRolPrivilegiosById";
  private apiCreateRolPrivilegios = this.api.getBaseUrl + "auth/rol/crearRolPrivilegios";
  private apiUpdateRolPrivilegios = this.api.getBaseUrl + "auth/rol/actualizarRolPrivilegios";
  private apiDeleteRolPrivilegiosById = this.api.getBaseUrl + "auth/rol/eliminarRolPrivilegiosById";
  private apiGetModulos = this.api.getBaseUrl + "auth/rol/getModulos";
