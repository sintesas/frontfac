...
export class UsuarioMenuService {
  ...
  private apiGetUsuarioMenu = this.api.getBaseUrl + "auth/usuariomenu/getUsuarioMenu";
  private apiCrudAsignarMenus = this.api.getBaseUrl + "auth/usuariomenu/crudAsignarMenus";
