...
export class EspecialidadService {
  ...
  private apiGetEspecialidadesFull = this.api.getBaseUrl + "auth/especialidad/getEspecialidadesFull";
  private apiGetEspecialidades = this.api.getBaseUrl + "auth/especialidad/getEspecialidades";
  private apiCreateEspecialidades = this.api.getBaseUrl + "auth/especialidad/crearEspecialidades";
  private apiUpdateEspecialidades = this.api.getBaseUrl + "auth/especialidad/actualizarEspecialidades";
