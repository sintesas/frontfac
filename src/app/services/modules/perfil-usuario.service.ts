...
export class PerfilUsuarioService {
  ...
  private apiGetPerfilesUsuarios = this.api.getBaseUrl + "auth/perfilusuario/getPerfilesUsuarios";
  private apiCreatePerfilesUsuarios = this.api.getBaseUrl + "auth/perfilusuario/crearPerfilesUsuarios";
  private apiUpdatePerfilesUsuarios = this.api.getBaseUrl + "auth/perfilusuario/actualizarPerfilesUsuarios";
