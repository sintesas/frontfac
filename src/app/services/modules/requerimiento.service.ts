...
export class RequerimientoService {
  ...
  private apiGetRequerimientos = this.api.getBaseUrl + "auth/requerimiento/getRequerimientos";
  private apiCreateRequerimientos = this.api.getBaseUrl + "auth/requerimiento/crearRequerimientos";
  private apiUpdateRequerimientos = this.api.getBaseUrl + "auth/requerimiento/actualizarRequerimientos";
