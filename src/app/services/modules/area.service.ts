...
export class AreaService {
  ...
  // Areas
  private apiGetAreasFull = this.api.getBaseUrl + "auth/area/getAreasFull";
  private apiGetAreas = this.api.getBaseUrl + "auth/area/getAreas";
  private apiCreateAreas = this.api.getBaseUrl + "auth/area/crearAreas";
  private apiUpdateAreas = this.api.getBaseUrl + "auth/area/actualizarAreas";
