...
export class CuerpoService {
  ...
  // Cuerpos
  private apiGetCuerposFull = this.api.getBaseUrl + "auth/cuerpo/getCuerposFull";
  private apiGetCuerpos = this.api.getBaseUrl + "auth/cuerpo/getCuerpos";
  private apiCreateCuerpos = this.api.getBaseUrl + "auth/cuerpo/crearCuerpos";
  private apiUpdateCuerpos = this.api.getBaseUrl + "auth/cuerpo/actualizarCuerpos";
